...
export default function DistributionChart() {
  ...
  const exportPDF = () => {
    html2canvas(chartRef.current).then(canvas => {
      ...
      pdf.save('distributionchart.pdf')
    })
  }
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'DistributionChart')
    XLSX.writeFile(wb, 'distributionchart.xlsx')
  }

  return (
    <div ref={chartRef} className="bg-white dark:bg-gray-800 p-4 shadow rounded">
      <div className="flex justify-between items-center mb-2">
        <h2 className="text-xl font-semibold">📊 DistributionChart</h2>
